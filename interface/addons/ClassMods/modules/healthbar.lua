	...
	if ClassMods.db.profile.healthbar.enabled then
		...
		ClassMods.F.HealthBar:SetScript("OnUpdate",
			function(self, elapsed)
				...
				elseif ClassMods.db.profile.healthbar.mountoverride and (IsMounted() or UnitHasVehicleUI("player") ) and (UnitBuff("player", "Telaari Talbuk") == nil) and (UnitBuff("player", "Frostwolf War Wolf") == nil) and (UnitBuff("player", "Rune of Grasping Earth") == nil) then
