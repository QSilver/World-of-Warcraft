	...
	if ClassMods.db.profile.altresourcebar.enabled then
		...
		ClassMods.F.AltResourceBar:SetScript("OnUpdate",
			function(self, elapsed)
				...
				elseif ClassMods.db.profile.altresourcebar.mountoverride and (IsMounted() or UnitHasVehicleUI("player") ) and (UnitBuff("player", "Telaari Talbuk") == nil) and (UnitBuff("player", "Frostwolf War Wolf") == nil) and (UnitBuff("player", "Rune of Grasping Earth") == nil) then
