		...
		if step then
			...
			for i,goal in ipairs(step.goals) do
				...
				if goal:IsCompleteable() then
					...
					s = s .. (" (%s, %s, %s progress, %s, '%s'%s)\n"):format(comp and "|cff00ff00COMPLETE|r" or "|cffffaa00incomplete|r", poss and "|cffbbff00POSSIBLE|r" or "|cff880000impossible|r", tostring(prog), step:IsAuxiliary() and "|cff8888ffAUX|r" or "|cff8888aanot aux|r" , explanation or "-", isbad and " WARNING" or "")
				else
