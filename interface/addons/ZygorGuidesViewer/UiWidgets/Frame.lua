...
function Frame:CanDrag(drag)
	if drag then
		...
		if drag == "parent" then
			CHAIN(self)
				:SetScript("OnDragStart",function(me) if me:GetParent() then me:GetParent():GetScript("OnDragStart")(me:GetParent()) end end)
				:SetScript("OnDragStop",function(me) if me:GetParent() then me:GetParent():GetScript("OnDragStop")(me:GetParent()) end end)
		else
			CHAIN(self)
