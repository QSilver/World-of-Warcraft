...
--]]
	...
	['gold_basic_4_sum'] = "Once the guide has loaded simply follow the instructions displayed on the Guide Viewer to behin making gold. Every guide will require you to perform different tasks like completing quests, or buying/farming/crafting items to sell on the Auction House, but in the end, permitting you've followed these instructions, you should make a profit.|n|nNote: Although Zygor's Gold and Auctions guide is pretty reliable and should make you money most of the time the WoW marketplace is an unpredictable place which means occasionally some items might expire before selling (especially using Expert mode or the more advanced methods). It's important to remain patient and remember that you might just need to relist your items to get them to sell. Also, all estimated values shown are based on the rates of a level 90 character.",
	['gold_basic_5_header'] = "05) Go forth and build your wealth",
	['gold_basic_5_sum'] = "Congratulations! You now know enough to begin using Zygor's Gold and Auctions guide. If you're more of a hands on learner then feel free to begin playing around with the guide now, otherwise click here to go back to the tutorial index and begin learning how to use the various gold making methods and tools found in Zygor's Gold and Auctions guide.",
	

	['gold_1_header'] = "01) Talk to an Auctioneer",
	['gold_1_sum'] = "The first thing you need to do is scan the auction house so you have the latest pricing data. Follow the arrow to be taken to the nearest Auctioneer, then speak with them to begin the scanning process.",
	['gold_2_header']	= "02) Scan the Auction House",
	['gold_2_sum'] = "This status of the scanning process will be shown at the bottom of the Auction Tools panel. Zygor's built in scanning feature will automatically trigger anytime you speak with an Auctioneer. Once the scan is complete it will show a timestamp allowing you to see when the last scan occured.\n\nWhen the scanning is complete click Next to continue.",
	...
	['gold_5_header']	= "4a) No.",
	['gold_5_sum'] = "The No. column shows you what number Zygor has ranked this item in terms of overall profitably. The items are listed in descending order with the most profitable items at the top.",
	['gold_6_header']	= "4b) Item",
	['gold_6_sum'] = "The Item column tells you the name of the item or items to be farmed in this guide.",
	['gold_7_header']	= "4c) Gold",
	['gold_7_sum'] = "The Gold column shows the estimated amount of gold that can be earned per hour when using this guide. This is determined by the multiplying the frequency of drops by the current market price of the items.\n\nNote: All values are based on the gathering rate of a level 90 character. ",
	['gold_8_header']	= "4d) Demand",
	['gold_8_sum'] = "The Demand column indicates how much of the item is generally stocked on the auction house over time. If the average supply is higher than the hourly drop rate then the status is set to High, otherwise the status will be Medium to Low.",
	['gold_9_header']	= "4e) Limit",
	['gold_9_sum'] = "The Limit column shows an adjusted estimate of the gold that can be earned farming this item when demand is lower than the hourly drop rate. Generally, this is the max amount of the item you can safely farm before you risk flooding the market.",
	['gold_10_header']	= "4f) Mode",
	['gold_10_sum'] = "You can switch between two different modes of display: Easy and Expert. In Easy Mode, all items with Low Demand will be hidden. Low Demand items can still be profitable, even most profitable, but might not sell as reliably or as quickly as higher Demand items. If you would like these items to be included you should use Expert Mode.",
	['gold_11_header'] = "4g) Filter",
	['gold_11_sum'] = "You can control what type of items are shown in the list using the Filter drop down.",
	...
	['gold_auctiontools_4_sum']	= "The Auction Tools have two modes of operation: Inventory View and Post View. You can switch between views by clicking the title tabs at the top of the frame.",
	...
	['gold_auctiontools_6_header']	= "03a) Inventory View - Items",
	['gold_auctiontools_6_sum']	= "The Items column shows your items and how much you have to sell.",
	['gold_auctiontools_7_header']	= "03b) Inventory View - Price",
	...
	['gold_auctiontools_8_header']	= "03c) Inventory View - Status",
	...
	['gold_auctiontools_9_header']	= "03d) Inventory View - Sell",
	['gold_auctiontools_9_sum']	= "The Sell column allows you to check which items you would like to sell. Each item checked will be added to the Post section. ",
	['gold_auctiontools_10_header']	= "04) Switch to Post View",
	['gold_auctiontools_10_sum']	= "Once you have added all the items you wish to sell click Post to switch to Post View.",
	['gold_auctiontools_11_header']	= "05) Post View",
	['gold_auctiontools_11_sum']	= "As soon as you switch to Post View the Auction Tools will rescan all of the items you have ready to sell to make sure you have the most competitive prices.",
	['gold_auctiontools_12_header']	= "05a) Smart Stacks",
	['gold_auctiontools_12_sum']	= "You can use the Smart Stacks feature to make sure you're always posting the correct amount of items. When enabled, Zygor will automatically post items in the optimal stack size and will limit the total quantity you post to prevent flooding the market.",
	['gold_auctiontools_13_header']	= "6) Post Your Items",
	['gold_auctiontools_13_sum']	= "Hit the Post button to begin posting your items. You will need to press the Post button for each item in the list. Once your items have sold you can use the Mail Tools to easily collect your gold. This concludes the Auction Tools walkthrough.\n\nClick here to view the Mail Tools walkthrough. ",
	...
	['gold_mailtools_7_sum']	= "Collect View shows you all the items you have waiting in your mailbox and allows you to collect everything with the click of one button.",
	['gold_mailtools_8_header']	= "",
	['gold_mailtools_8_sum']	= "",
	['gold_mailtools_9_header']	= "",
	['gold_mailtools_9_sum']	= "",
	...
	["gold_crafting_error_noprofession"] = "You don't have a crafting profession.\nYou need to learn Alchemy, Blacksmithing, Engineering, Inscription, Jewelcrafting, Tailoring, or Leatherworking.",
