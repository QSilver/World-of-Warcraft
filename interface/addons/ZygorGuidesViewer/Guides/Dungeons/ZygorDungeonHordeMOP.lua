...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\End Time (ET)\\End Time (ET) Tank Gear",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\End Time (ET)\\End Time (ET) Dps Gear",[[
mapid 820
description This will help you see what gear you can use in the End Time Dungeon
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\End Time (ET)\\End Time (ET) Healer Gear",[[
description This will help you see what gear you can use in the End Time Dungeon
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\Well of Eternity (WoE)\\Well of Eternity (WoE) Tank Gear",[[
description This will help you see what gear you can use in the End Time Dungeon
step
...
only DeathKnight, Paladin, Warrior, Druid
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\Well of Eternity (WoE)\\Well of Eternity (WoE) Dps Gear",[[
mapid 816
description This will help you see what gear you can use in the End Time Dungeon
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\Well of Eternity (WoE)\\Well of Eternity (WoE) Healer Gear",[[
description This will help you see what gear you can use in the End Time Dungeon
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\Hour of Twilight (HoT)\\Hour of Twilight (HoT) Tank Gear",[[
description This will help you see what gear you can use in the End Time Dungeon
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\Hour of Twilight (HoT)\\Hour of Twilight (HoT) Dps Gear",[[
mapid 819
description This will help you see what gear you can use in the End Time Dungeon
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Gear Guides\\Cataclysm Dungeons\\Hour of Twilight (HoT)\\Hour of Twilight (HoT) Healer Gear",[[
description This will help you see what gear you can use in the End Time Dungeon
step
...
step
label	"pre_Tyrande"
from Echo of Tyrande##54544 |goto End Time/5 51.8,42.9
...
step
label	"pre_Sylvanas"
from Echo of Sylvanas##54123 |goto End Time/3 55.8,39.0
...
_Healer:_ Adarogg will periodically use _Flame Breath_ on a random player dealing fire damage to them. This will need to be healed
...
_Tank:_ Interrupt _Twisted Elements_
_DPS:_ Interrupt _Twisted Elements_
_Healers:_ Be prepared to heal targets of _Twisted Elements_ and those taking damage during _Shadow Storm_
...
Slagmaw will periodically _Submerge_, reappearing at a random location.
_Healers:_ Be prepared to heal group members who are hit by _Lava Spit_, especially following _Submerge_
...
_Healers:_ Keep the party as close to full health as possible. Knockback may interrupt your cast
...
step
kill 1 Glubtok##47162 |n |goto 37.7,61.2 |only if default
kill 1 Glubtok##47162 |q Only the Beginning##27842/1 |goto 37.7,61.2 |only if havequest(27842)
Phase 1:
Glubtok will occasionally use _Fists of Flame_ and _Fists of Frost_ during this phase, avoid standing near the tank
_Tank_: Glubtok will periodically _Blink_ to a random location
tip Blink will reset threat, pick up Glubtok quickly. |only if heroic_dung()
_
Phase 2:
At 50% health, Glubtok will cast beams of fire and frost to his sides. Stand in front or behind him
Glubtok will throw _Fire Blossoms_ and _Frost Blossoms_ at random locations, avoid standing in the impact area
_Heroic Difficulty:_ Blossoms summon weak elementals. Kill these quickly |only if heroic_dung()
_Heroic Difficulty:_ Glubtok will cast a wall of fire that rotates around the room, avoid contact |only if heroic_dung()
...
step
kill 1 Helix Gearbreaker##47296 |n |goto 49.0,87.4 |only if default
kill 1 Helix Gearbreaker##47296 |q Traitors!!!##27844/1 |goto 49.0,87.4 |only if havequest(27844)
Phase 1:
_Sticky Bombs_ will explode if players are within 1 yard of them
The Lumbering Oaf will use _Oaf Smash_, picking up a random player and running into the wall. |only if not heroic_dung()
The Lumbering Oaf will use _Oaf Smash_, picking up a random player and running into the wall dealing 100% of their maximum health as physical damage |only if heroic_dung()
_Helix_ will jump on a random player. This player will take normal melee damage for 10 seconds
When Helix jumps to a new target, he leaves a _Chest Bomb_ behind. Position yourself below the log in the room so you don't fly up in the air and die from fall damage |only if heroic_dung()
_
Phase 2:
Helix will _Leap_ onto a player and melee attack them
Helix will continue to attach _Chest Bomb_ to targets |only if heroic_dung()
...
step
kill 1 Foe Reaper 5000##43778 |n |goto The Deadmines/2 10.4,82.8 |only if default
...
Foe Reaper 5000 will use _Reaper Strike_, cleaving anyone in front of it
When _Overdrive_ is cast, run away and keep moving until it ends
Occasionally a party member will be targeted with _Harvest_. Avoid being in front of the Foe Reaper as he moves to the target
_Tank:_ Pull the Foe Reaper to the top of the ramp |only if heroic_dung()
_Healer:_ Be prepared for party members to take damage during _Overdrive_
...
step
kill 1 Admiral Ripsnarl##47626 |n |goto 63.9,39.5 |only if default
kill 1 Admiral Ripsnarl##47626 |q Good Intentions...Poor Execution##27848/1 |goto 63.9,39.5 |only if havequest(27848)
Ripsnarl will use _Swipe_, cleaving in a frontal cone. Avoid standing in front of him
Ripsnarl will gain _Thirst for Blood_, moving faster and gaining attack speed each time he hits (stacking up to 20 times)
...
When the fog ends, Ripsnarl will randomly target someone with _Go for the Throat_, stunning them and dealing damage
_Healer:_ Ripsnarl will use _Go for the Throat_ through the entire encounter. Prepare to heal accordingly |only if heroic_dung()
...
step
kill 1 "Captain" Cookie##47739 |n |goto 63.9,39.5 |only if completedq(27850)
kill 1 "Captain" Cookie##47739 |q The Defias Kingpin##27850/1 |goto 63.9,39.5 |only if not completedq(27850)
Cookie will throw regular food and rotten food on the ground. Rotten food will deal damage to anyone standing nearby
Eating good food will remove a stack of bad food and grant a stacking haste buff
Your group must balance eating bad food and good food to keep the deck clear
...
VanCleef will use _Deflection_, which deflects all ranged, melee and spell attacks for 10 seconds. She will use the ability when her health is higher than 25%
...
_Tank:_ VanCleef will summon Defias Shadowguard and Defias Blood Wizards. These need to be picked up quickly
...
step
label "start"
Press _I_ and queue for Wailing Caverns |confirm |or
Or
Enter the dungeon with your group |goto Wailing Caverns/1 45.8,59.7 < 100 |c |or
step
talk Ebru##5768
...
path	32.9,40.3
_Follow_ the path |goto 32.9,40.3 < 8 |c |noway
step
...
Lady Anacondra will cast _Lightning Bolt_ on her current target
She will also put random players to sleep using _Druid's Slumber_
Anacondra will periodically attempt to heal herself or an ally with _Healing Touch_
_DPS/Tank:_ Be sure to save an interrupt for _Healing Touch_. Interrupt _Druid's Slumber_ whenever possible
_Healer:_ Keep the tank topped off in case you get put to sleep
...
path	15.8,39.0
_Jump in the water_ and follow this path |goto 15.8,39.0 < 5 |c |noway
step
kill 1 Lord Pythas##3670 |only if default
kill 1 Lord Pythas##3670 |q Cleansing the Caverns##26870/3 |only if havequest(26870)
Lord Pythas will cast _Lightning Bolt_ on his current target
He will also put random players to sleep using _Druid's Slumber_
Pythas will periodically attempt to heal himself or an ally with _Healing Touch_
Players within 10 yards will occasionally take nature damage and suffer reduced attack speed from _Thunder Clap_
_DPS/Tank:_ Be sure to save an interrupt for _Healing Touch_. Interrupt _Druid's Slumber_ whenever possible
_Healer:_ Keep the tank topped off in case you get put to sleep
...
Lord Cobrahn will cast _Lightning Bolt_ on his current target
He will also put random players to sleep using _Druid's Slumber_
Cobrahn will periodically attempt to heal himself or an ally with _Healing Touch_
At 45% health, Cobrahn will gain _Serpent Form_. He will begin using _Poison_ on players. Dispel this when possible
_DPS/Tank:_ Be sure to save an interrupt for _Healing Touch_. Interrupt _Druid's Slumber_ whenever possible
_Healer:_ Keep the tank topped off in case you get put to sleep
...
Lord Serpentis will cast _Lightning Bolt_ on his current target
He will also put random players to sleep using _Druid's Slumber_
Serpentis will periodically attempt to heal himself or an ally with _Healing Touch_
_DPS/Tank:_ Be sure to save an interrupt for _Healing Touch_. Interrupt _Druid's Slumber_ whenever possible
_Healer:_ Keep the tank topped off in case you get put to sleep
Defeat Lord Serpentis |scenariogoal 24771 |goto 62.6,53.3
step
kill 1 Verdan the Everliving##5775 |goto 56.4,47.5
Verdan the Everliving has one ability, _Grasping Vines_
_Grasping Vines_ will periodically knock down players within 10 yards and immobilize them for 5 seconds
_Tanks:_ Make use of defenisive cooldowns, especially during _Grasping Vines_
_Healer:_ Be prepared, Verdan the Everliving may deal significant damage to undergeared tanks
|confirm
step
...
path	44.2,52.5
_Follow_ the path |goto 44.2,52.5 < 8 |c |noway
step "Quests"
...
_DPS/Tank:_ Interrupt _Naralex's Nightmare_. This will put players to sleep for 8 seconds
Mutanus will _Terrify_ random players. Dispel this if possible
Occasionally, Mutanus will use _Thundercrack_, dealing damage to all players within 10 yards and stunning them
...
goto 31.8,66.9
.talk 44387
..accept 26899 |only if not havequest(26899)
...
.from Grubbis##7361
|confirm
|modelnpc Caverndeep Ambusher##6207+, Caverndeep Burrower##6206+, Chomper##6215
step
goto 57.6,51.4 |n
...
..collect Fel Orc Blood Vial##23894 |q 29535/1
...
.talk 17827 |only if havequest(29570)
...
goto 74.5,57.7
.talk 17876
.' _CAUTION_ |tip Make sure everyone in your group is ready before talking to Thrall.
.' Tell him:
...
step
label start
goto Magisters' Terrace/2 42.6,87.2
.talk 55007
..accept 29684
..accept 29686
..accept 29687
...
|confirm
|modelnpc Marshal Jacob Alerius##34705, Ambrose Boltspark##34702, Jaelyne Evensong##34657
step
...
|modelnpc Colosos##34701, Ambrose Boltspark##34702, Lana Stouthammer##34703, Marshal Jacob Alerius##34705, Jaelyne Evensong##34657
|confirm
step
goto 54.2,48.4
...
|modelnpc Titanium Vanguard##28838, Stormforged Runeshaper##28836+
step
goto 19.2,59.8
...
.talk 36990 |tip you will have to wait for her to show up.
.turnin 24712
step
goto Pit of Saron 48.2,18.9
.talk 36990
...
.talk 37223
.turnin 24713 |only if havequest(24713)
step
goto 36.2,76.3
...
|modelnpc Ghostly Priest##38175, Shadowy Mercenary##38177, Phantom Mage##38172, Tortured Rifleman##38176, Spectral Footman##38173
step
...
goto 12.9,23.2
.talk 37554
.accept 24802 |only if not completedq(24802) and not havequest(24802) and completedq(24713)
...
|modelnpc 3 Faceless Sapper##44752, Vicious Mindlasher##44715, Unyielding Behemoth##44648, Blight Beast##44841, Ozumat##44566
|confirm
step
goto Throne of the Tides,49.9,90.6
.talk 50272
...
.' _Phase 2:_
.' When he casts _Shield of Light_ he becomes immune to damage.
...
step
goto 66.4,48.3
.click The Maker's Lift Controller##8504 |n
...
.' _Phase 1_
.' The tank should pull the _Pride of Bethekk_ and keep aggro on Kilnara.
...
goto 20.6,45.9
.click Blade of the Anointed
.get Blade of the Anointed |q 31515/1
step
map Scarlet Monastery/1
path follow strict;loop off;ants straight
path	34.5,52.5	34.8,78.2	39.4,81.7
...
.from Striker Ga'dok##56589 |tip Watch where he flies during Strafing Run. Do not be on that side.
|confirm
step
...
accept Signet of the Unseen Path##8704
|only Hunter
step
goto 59.5,14.0
talk Keyl Swiftclaw##15500
accept Cloak of Unending Life##8692
|only Druid
step
goto 59.5,14.0
talk Warden Haro##15499
accept Mace of Unending Life##8708
|only Druid
step
goto 59.4,14.1
talk Windcaller Yessendra##15498
accept Band of Unending Life##8700
|only Druid
step
goto 59.5,14.0
talk Keyl Swiftclaw##15500
accept Drape of Vaulted Secrets##8691
|only Mage
step
goto 59.5,14.0
talk Warden Haro##15499
accept Blade of Vaulted Secrets##8707
|only Mage
step
goto 59.4,14.1
talk Windcaller Yessendra##15498
accept Band of Vaulted Secrets##8699
|only Mage
step
goto 59.5,14.0
talk Keyl Swiftclaw##15500
accept Cloak of Veiled Shadows##8693
|only Rogue
step
goto 59.5,14.0
talk Warden Haro##15499
accept Dagger of Veiled Shadows##8709
|only Rogue
step
goto 59.4,14.1
talk Windcaller Yessendra##15498
accept Band of Veiled Shadows##8701
|only Rogue
step
goto 59.5,14.0
talk Keyl Swiftclaw##15500
accept Cape of Eternal Justice##8695
|only Paladin
step
goto 59.5,14.0
talk Warden Haro##15499
accept Blade of Eternal Justice##8711
|only Paladin
step
goto 59.4,14.1
talk Windcaller Yessendra##15498
accept Ring of Eternal Justice##8703
|only Paladin
step
goto 59.5,14.0
talk Keyl Swiftclaw##15500
accept Cloak of the Gathering Storm##8690
|only Shaman
step
goto 59.5,14.0
talk Warden Haro##15499
accept Hammer of the Gathering Storm##8706
|only Shaman
step
goto 59.4,14.1
talk Windcaller Yessendra##15498
accept Ring of the Gathering Storm##8698
|only Shaman
step
goto 59.5,14.0
talk Keyl Swiftclaw##15500
accept Drape of Unyielding Strength##8557
|only Warrior
step
goto 59.5,14.0
talk Warden Haro##15499
accept Sickle of Unyielding Strength##8558
|only Warrior
step
goto 59.4,14.1
talk Windcaller Yessendra##15498
accept Signet of Unyielding Strength##8556
|only Warrior
step
goto 59.5,14.0
talk Keyl Swiftclaw##15500
accept Shroud of Infinite Wisdom##8689
|only Priest
step
goto 59.5,14.0
talk Warden Haro##15499
accept Gravel of Infinite Wisdom##8705
|only Priest
step
goto 59.4,14.1
talk Windcaller Yessendra##15498
accept Ring of Infinite Wisdom##8697
|only Priest
step
goto 59.5,14.0
talk Keyl Swiftclaw##15500
accept Shroud of Unspoken Names##8694
|only Warlock
step
goto 59.5,14.0
talk Warden Haro##15499
accept Kris of Unspoken Names##8710
|only Warlock
step
goto 59.4,14.1
talk Windcaller Yessendra##15498
accept Ring of Unspoken Names##8702
|only Warlock
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Shadowfang Keep",[[
mapid 764
description This guide will walk you through the Shadowfang Keep dungeon.
achieveid 631
author support@zygorguides.com
...
step
kill 1 Baron Ashbury##46962 |goto Shadowfang Keep/1 67.8,72.9 |only if default
Baron Ashbury will periodically throw everyone in the air using _Asphyxiate_, dropping player health to 1 over 6 seconds
Following _Asphyxiate_, he will use _Stay of Execution_. This will heal all party members to 50% |only if not heroic_dung()
Following _Asphyxiate_, he will use _Stay of Execution_. This will heal all party members for 10% of their health and himself for 5% health every second until interrupted |only if heroic_dung()
Ashbury will channel _Pain and Suffering_ on a random player, dealing increasing shadow damage over 6 seconds
_Wracking Pain_ will deal shadow damage and increase shadow damage taken by 20% for each stack |only if heroic_dung()
At 25% health, Ashbury will use _Calamity_. This will deal damage every second to the group and increase in damage until he or the party dies. Soft enrage |only if heroic_dung()
...
step
kill 1 Baron Silverlaine##3887 |goto Shadowfang Keep/2 31.2,73.3 |only if default
He will cast _Veil of Shadow_, which reduces healing taken by 50%. Decurse this as often as possible
_Cursed Veil_ will deal shadow damage to the entire group and reduce healing by 75% for 8 seconds. Dispel this whenever possible |only if heroic_dung()
At 70% and 35% he will cast _Summon Worgen Spirits_ |only if not heroic_dung()
...
step
kill 1 Commander Springvale##4278 |goto Shadowfang Keep 28.4,58.6 |only if default
Springvalve will use _Malefic Strike_ to gain Unholy Power for his abilities
At 3 charges of Unholy Power, he will use _Shield of the Perfidious_. This deals shadow damage 6 times over 3 seconds in a 25 degree frontal cone |only if not heroic_dung()
At 3 charges of Unholy Power, he will use _Shield of the Perfidious_. This deals shadow damage 6 times over 3 seconds in a 150 degree frontal cone |only if heroic_dung()
Occasionally he will _Desecrate_ an area under a player, slowing their movement speed and dealing damage. Move out of this quickly
At 3 Unholy Power, Springvalve can use _Word of Shame_; this places a dot on a random player dealing 5% of max health every 3 seconds until the encounter ends |only if heroic_dung()
Periodically, Springvalve will summon adds. Casters should stay away from Guardsman to prevent being interrupted |only if heroic_dung()
_DPS/Tank:_ Interrupt _Unholy Empowerment_ from Guardman and Officers and _Forsaken Ability_ from Officers |only if heroic_dung()
_Healer:_ Guardsman will use _Mortal Strike_ on the tank. Prepare for this reduction in healing |only if heroic_dung()
...
step
kill 1 Lord Walden##46963 |goto Shadowfang Keep/4 54.2,54.3 |only if default
Lord Walden will use _Ice Shards_. These explode on the ground. Stay out of the impact areas
He will also _Conjure Poisonous Mixture_. Stay away from the poison on the ground
Walden will use _Conjure Mystery Toxin_. If the result is _Toxic Coagulant_, keep moving to keep your stacks below 3 |only if heroic_dung()
If the conjured toxin is _Toxic Catalyst_, use any DPS cooldowns you have, as you will have 100% critical strike |only if heroic_dung()
_Healer:_ Pay special attention to party members afflicted with _Toxic Coagulent_ and _Toxic Catalyst_ |only if heroic_dung()
...
step
kill 1 Lord Godfrey##46964 |goto Shadowfang Keep/6 61.6,23.8 |only if default
Lord Godfrey will shoot _Cursed Bullets_ at a random player; interrupt this quickly
Godfrey will apply _Mortal Wound_ to his current target, reducing healing by 5% per stack. Stacks 10 times
Occasionally, he will _Summon Bloodthirsty Ghouls_ where the 6 bullets land. Kill these ghouls when they spawn
When Godfrey uses _Pistol Barrage_, he will deal massive damage in a 60 degree frontal cone. Do not stand in front of him during this |only if heroic_dung()
kill 1 Lord Godfrey##46964 |q Sweet, Merciless Revenge##27998/1 |goto Shadowfang Keep/6 61.6,23.8 |only if havequest(27998)
Defeat Lord Godfrey |scenariogoal 18525 |goto Shadowfang Keep/6 61.6,23.8
step
talk Deathstalker Commander Belmont##47293
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Blackfathom Deeps (BFD) 22-27 *Test*",[[
mapid 688
description This guide will walk you through the Blackfathom Deeps dungeon.
achieveid 632
author support@zygorguides.com
step
label "start"
Press _I_ and queue for Blackfathom Deeps enter the dungeon with your group |goto Blackfathom Deeps/1 44.8,10.6 |c
step
talk Zeya##74409
...
step
kill 1 Ghamoo-Ra##74446 |goto 33.5,59.4
Ghamoo-Ra will use _Shell Shocker_, targeting a random player and charging to them, releasing a violent burst of energy. Stay spread out to avoid multiple party members taking damage
Every 3 seconds, Ghamoo-Ra will release a _Static Shock_. This will deal minor nature damage to random party members.
Defeat Ghamoo-ra |scenariogoal 24409 |or |goto 33.5,59.4
Start the scenario |confirm |or
step
map Blackfathom Deeps/1
path follow loose; loop off; ants curved
...
path	14.6,43.2
_Swim_ under the water and follow the path |goto Blackfathom Deeps 14.6,43.2 < 10 |noway |c
step
kill 1 Domina##74476 |goto 11.7,41.3
click Altar of Blood
Domina will occasionally summon a _Foul Tempest_ that will inflict shadow damage every second to random players
She will also use _Maw of Death_, which deals massive shadow damage to anyone in front of her over 2 seconds. Avoid standing in front of her
_Healer:_ Pay attention to anyone standing in front of Domina during _Maw of Death_, as they will take significant damage
...
_Swim_ under the water and follow the path |goto 55.8,63.2 < 5 |c |noway
step
kill 1 Subjugator Kor'ul##74565 |goto Blackfathom Deeps/1 54.3,57.0
Kor'ul will use _Leviathan's Grip_, crushing a random party member over 8 seconds
When he uses _Darkness Calls_, Kor'ul will summon Aku'mai tentacles. Kill these quickly and avoid the areas of ground they target
_Healer:_ Heal the player targeted by _Leviathan's Grip_
...
Thruk will use _Catch of the Day_, using his fishing line to pull a random party member to his feet and rooting them for 10 seconds
Shortly after _Catch of the Day_, Thruk will use _Fillet of Flesh_. This will deal heavy physical damage to anyone within 10 yards. Avoid being close to him
...
Executioner Gore will use _Devouring Blackness_ on a random player, draining life and dealing damage
Gore will also slam his axe down in an _Executioner's Strike_, dealing damage in a frontal cone area and leaving a vortex. Move out of the vortex
_DPS/Tank:_ Interrupt _Devouring Blackness_
Defeat Executioner Gore |scenariogoal 24411 |goto 40.7,77.9 < 5 |c |noway
step
map Blackfathom Deeps/2
path follow loose; loop off; ants curved
...
Bathiel will use _Restorative Waters_, spraying parts of himself across the room and summoning elementals
These elementals should be killed quickly, as some of them will explode and some will heal Bathiel
_Piercing Rain_ will immediately follow _Restorative Waters_ and deal AoE damage to the entire group
_DPS:_ Kill elementals quickly
_Tank:_ Don't worry about picking up adds
_Healer:_ Prepare to heal the group during _Piercing Rain_
...
_Phase 1:_
Aku'mai will spit _Venom_ at his target, dealing nature damage
He will also gradually become more present through _Tearing the Void_, summoning _Deep Terrors_
Random players will be hit with _Falling Debris_, suffering physical damage
_Phase 2:_
Aku'mai the Venomous continues to use _Venom_
In addition, he will spit _Toxic Bile_ at a random player. This leaves behind a bile pool that you must move out of
_Deep Terrors_ will periodically crush the ground. Move away from the areas targeted
kill 1 Aku'mai the Devourer##75155 |q The Rise of Aku'mai##34672/1 |goto 86.5,86.7 |only if havequest(34672)
Defeat Aku'mai |scenariogoal 24413 |goto 86.5,86.7
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\The Stockade (STOCKS) 22-27 *Test*",[[
mapid 690
description This guide will walk you through the Stockade dungeon.
achieveid 633
author support@zygorguides.com
...
Randolph will start _Wildly Stabbing_ occasionally, attacking significanly faster but at a reduced chance to hit
He will use _Sweep_, attacking both the tank and the closest additional party member
At around 65% and 35% health, Randolph will _Vanish_, reappearing behind a random player and attacking them
...
Lord Overheat will cast _Rain of Fire_, lasting for 9 seconds. Move out of the area targeted
He will use _Fireball_ on his current target
Occasionally, he will target a party member with _Overheat_. This will deal fire damage over 9 seconds
...
Hogger will use _Vicious Slice_, dealing damage instantly as well as 15% of the target's health over 6 seconds
He will also use _Maddening Call_, dealing damage to the party and reducing attack and cast speed by 60%
At 30%, Hogger will _Enrage_. This will dramatically increase his damage output
_DPS/Tank:_ Interrupt _Maddening Call_ as often as possible
Defeat Hogger |scenariogoal 18527 |goto 22.1,27.0
step
Congratulations, you have completed The Stockade!
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Gnomeregan (Gnomer) 26-31 *Test*",[[
mapid 691
description This guide will walk you through the Gnomeregan dungeon.
achieveid 634
author support@zygorguides.com
...
Tell her: _"I am ready to begin"_ |goto 81.9,65.1
This will begin the Grubbis event. 2 waves of enemies will spawn when the walls break down before he emerges to attack the party
You will need to kill the waves of troggs that come out. This will last about 60 seconds per side
Grubbis will use _Strike_ on his current target
Grubbis is accompanied by _Chomper_, his loyal basilisk pet
Defeat Grubbis |scenariogoal 24958 |or |goto 77.3,65.6
Start the scenario |confirm |or
step
map Gnomeregan/1
path follow loose; loop off; ants curved
...
step
kill 1 Viscous Fallout##7079 |goto 83.9,45.5
Viscous Fallout patrols around this area
He will only use one ability on the party, _Toxic Volley_
_Toxic Volley_ will place a nature damage DoT on party members that will deal damage over 15 seconds
...
step
kill 1 Electrocutioner 6000##6235 |goto 23.7,68.3
Electrocutioner will use _Megavolt_, inflicting nature damage to all players in front of him
He will also use _Shock_ on his current target, dealing heavy nature damage
_Chain Bolt_ will strike a target and jump to 3 nearby targets, dealing nature damage to each. Stay spread out
_DPS/Tank:_ Interrupt _Megavolt_ and _Chain Bolt_ whenever possible
Defeat Electrocutioner 6000 |scenariogoal 24960 |goto 23.7,68.3
step
Walk to this ledge |goto Gnomeregan/2 23.9,73.3 < 5 |n
Jump down |goto Gnomeregan/3 30.3,35.8 |c |noway
step
map Gnomeregan/3
path follow loose; loop off; ants curved
...
step
kill 1 Crowd Pummeler 9-60##6229 |goto Gnomeregan/3 43.5,86.8
Crowd Pummeler will use _Arcing Smash_, a frontal cone cleave attack. Avoid standing in front of him
He will also use _Crowd Pummel_, damaging all enemies within 10 yards and interrupting spell casting. Stay at range if you can
Occasionally, he will _Trample_ party members within 10 yards for physical damage
...
_Follow_ the path and open The Final Chamber door |goto 28.8,45.7 |c |noway
step
kill 1 Mekgineer Thermaplugg##7800 |goto 31.3,29.9
_Steam Blast_ will inflict fire damage to Thermaplugg's current target and knock them back
_Pound_ will deal damage and disorient his current target
Thermaplugg will also use _Welding Beam_ on his current target. This will deal nature damage over 5 seconds
Periodically, he will activate _Walking Bombs_. These bombs will keep spawning until the red button on the side of the tube is pressed
_Walking Bombs_ will move towards players and _Detonate_, dealing fire damage in a 10 yard radius
_DPS/Tank:_ Interrupt _Steam Blast_ and _Welding Beam_ as often as possible
Defeat Mekgineer Thermaplugg |scenariogoal 18529 |goto 31.3,29.9
step
Congratulations, you have completed Gnomeregan!
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Scarlet Halls (SH) 28-31 *Test*",[[
mapid 871
dungeondifficulty Normal
description This guide will walk you through the Scarlet Halls dungeon.
achieveid 7413
author support@zygorguides.com
step
Press _I_ and queue for Scarlet Halls or enter the dungeon with your group |goto Scarlet Halls/1 34.3,90.1 |c
...
_Allow the remaining dogs to kill the door guards_ and proceed along the path. |goto Scarlet Halls/2 61.7,54.5 < 5 |noway |c
step
kill 1 Armsmaster Harlan##58632 |goto Scarlet Halls/2 61.8,45.2
_Dragon's Reach_ is a cleave ability, avoid being in front of this boss.
Harlan will periodically summon two _Scarlet Defenders_. You can either kill these adds or you can wait for them to be caught in Harlan's _Blades of Light_ ability.
He will use _Heroic Leap_ to the center of the pit and begin casting _Blades of Light_. This whirlwind quickly moves around the entire area and does massive damage to anybody caught within it. Jump between the different levels of this area to avoid this ability easily.
_Healer_ Avoid standing near the door. The adds will spawn and immediately begin attacking you
...
Defeat Flameweaver Koegler |scenariogoal 19269 |goto 39.3,15.9
step "RankFile"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Scarlet Monastery (SM) 30-33 *Test*",[[
mapid 874
dungeondifficulty Normal
description This guide will walk you through the Scarlet Monastery dungeon.
achieveid 637
author support@zygorguides.com
step
Press _I_ and queue for Scarlet Monastery or enter the dungeon with your group |goto Scarlet Monastery/1 74.7,45.8 < 100 |c
step
...
Thalnos will _Raise Fallen Crusader_. This ability summons zombies that the tank needs to pick up. When the Fallen Crusaders hit you, they leave behind _Mind Rot_ which is a DoT that can stack
He also summons _Spirit Gales_ often. These are puddles on the ground that should not be stepped in. This ability is interruptable
_Evict Soul_ is a debuff that Thalnos throws on a random party member. This DoT needs to be dispelled as quickly as possible
He will also use _Summon Empowering Spirit_. This ability will summon an add that DPS should kill as quickly as they can. If this add reaches a Fallen Crusader's corpse, it will spawn an _Empowered Zombie_
_Empowered Zombies_ are large zombies which need to be tanked. They cannot be killed without great focus
Defeat Thalnos the Soulrender |scenariogoal 19270 |or |goto Scarlet Monastery/1 24.3,45.6
Start the scenario |confirm |or
step
...
_Phase 1_
Commander Durand will fight you alone.
He uses _Flash of Steel_ and _Dashing Strike_. Both of these abilities cause him to jump to party members quickly
_Phase 2_
High Inquisitor Whitemane will cast _Power Word: Shield, Smite and Heal_. Make sure to interrupt Heal
Whitemane will also try casting _Mass Resurrection_. _DO NOT LET THIS CAST FINISH!!_ If this cast finishes, all corpses within 100 yards will resurrect and aggro
After you weaken her she will cast _Deep Sleep_. This puts the entire party to sleep for 10 seconds, during this time she will resurrect Durand
_Phase 3_
Kill Whitemane first, make sure to interrupt _Heal_
...
Defeat High Inquisitor Whitemane |scenariogoal 19273 |goto Scarlet Monastery/2 49.1,77.9
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Razorfen Kraul (RFK) 32-37 *Test*",[[
mapid 761
description This guide will walk you through the Razorfen Kraul dungeon.
achieveid 635
author support@zygorguides.com
step
label	"start"
Press _I_ and queue for Razorfen Kraul or enter the dungeon with your group |goto Razorfen Kraul/1 69.9,83.0 < 100 |c
step
talk Auld Stonespire##44402
accept Going, Going, Guano!##26901 |goto Razorfen Kraul/1 68.3,83.0
...
When below 75% health, Roogug will occasionally use _Bloodlust_. This is a stacking enrage effect
_Woven Elements_ will create a vortex of random elemental effects that deal damage
_Crystalfire Discharge_ creates a totem that shoots energy at random players, knocking them back and dealing damage
_Solarshard Beam_ will create a bright pillar of light, silencing anyone within. Move out of this
_DPS/Tank:_ Interrupt _Woven Elements_
kill 1 Roogug##74948 |q Take Them Down!##26907/3 |goto Razorfen Kraul/1 87.2,41.6 |only if havequest(26907)
Defeat Roogug |scenariogoal 24979 |or |goto Razorfen Kraul/1 87.2,41.6
Start the scenario |confirm |or
step
map Razorfen Kraul/1
path follow loose; loop off; ants curved
...
At 50% health, Bonetusk will call a _Stampede_ of boars. Avoid the boars to prevent taking damage
Dodge the incoming arrows from _Volley_
_Tank:_ Be prepared for extra incoming damage during _Barrage_. Bonetusk will fire multiple arrows very rapidly for a short time
...
_Spirit Link Totem_ will periodically redistribute the health of all targets inside the field
Ramtusk will use _Spirit Axe_, throwing his axe to a location and dealing arcane damage to all nearby enemies
Jargba will use _Spirit Bolt_, causing a orb of energy to randomly move towards a party member
Aggem will occasionally _Arcane Shot_ a random player, dealy heavy arcane damage
_DPS/Tank:_ Interrupt Jargba's _Spirit Bolt_
_Healer:_ Pay close attention to _Arcane Shot_ targets, they will take significant damage
...
step
kill 1 Groyat, the Blind Hunter##75247
_Sonic Field_ will create areas on the ground which deal physical damage to those who stand in them. After a few seconds, anyone nearby will take damage and be stunned for 4 seconds
Groyat will bite his current target occasionally, inflicting them with _Drain Life_
Dispel _Drain Life_ whenever possible
...
_Follow_ the path |goto 18.7,39.3 < 5 |noway |c
step
...
_Venomous Discharge Crystal_ will lob poison poison at random players. Avoid the areas targeted
_Tidal Tempest Crystal_ will pull party members towards its center, dealing frost damage. Run away
_Molten Inferno Crystal_ will create lines of fire around the room. Avoid standing in these, as they do high fire damage
Dispel players afflicted by _Elemental Binding_ as often as possible. This debuff will inflict random elemental damage over 6 seconds and root the player
Collect Razorflank's Heart |q Agamaggan's Charge##26905/1 |goto 23.7,31.4 |only if havequest(26905)
Defeat Charlga Razorflank |scenariogoal 18528 |goto 23.7,31.4
step
talk Spirit of Agamaggan##44415
...
only if not completedq(26907)
step
Congratulations, you have completed Razorfen Kraul!
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Maraudon: The Wicked Grotto (Mara) 33-38 *Test*",[[
mapid 750
description This guide will walk you through the Maraudon: The Wicked Grotto dungeon.
author support@zygorguides.com
step
label "start"
Press _I_ and queue for Maraudon: The Wicked Grotto or enter the dungeon with your group |goto Maraudon/1 78.5,68.5 < 100 |c
step
...
Tinkerer Gizlock will occasionally throw a _Bomb_ as someone, inflicting AoE damage. Stay at least 5 yards apart
_Goblin Dragon Gun_ will deal fire damage in a frontal cone. Avoid standing in front of him
_Flash Bomb_ will cause all beasts, including Feral/Guardian Druids and hunter pets to flee for 5 seconds
Gizlock will randomly _Shoot_ party members, dealing minor physical damage
Defeat Tinkerer Gizlock |scenariogoal 25051 |or |goto 48.7,56.2
Start the scenario |confirm |or
step
map Maraudon
path follow loose; loop off; ants curved
...
_Shoot_ will deal minor physical damage to random party members
Stay spread out so that _Multi-Shot_ does not hit more than one party member at a time
Occasionally, Vyletongue will _Blink_ 20 yards straight forward
_Smoke Bomb_ will stun any players within 5 yards
kill 1 Lord Vyletongue##12236 |q Corruption in Maraudon##27697/1 |goto 37.6,69.5 |only if havequest(27697)
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dungeon Guides\\Classic Dungeons\\Maraudon: Foulspore Cavern (Mara) 35-40 *Test*",[[
mapid 750
description This guide will walk you through the Marudon: Foulspore Cavern dungeon.
author support@zygorguides.com
step
label	"start"
Press _I_ and queue for Maraudon: Foulspire Caverns or enter the dungeon with your group |goto Maraudon/1 62.2,28.2 < 100 |c
step
Click the Accept Quest box on the right side of your screen.
...
_Toxic Volley_ will poison all players within 45 yards for 15 seconds
Noxxion will _Uppercut_ the tank, knocking them back
When he begins to _Summon Noxxion Spawn_ Noxxion will split into 5 Noxxion Spawn
Kill Noxxion Spawn during splits
kill 1 Noxxion##13282 |q Servants of Theradras##27698/1 |goto 34.6,10.7 |only if havequest(27698)
Defeat Noxxion |scenariogoal 25054 |or |goto 34.6,10.7
Start the scenario |confirm |or
step
map Maraudon/1
path follow loose; loop off
...
Razorlash will _Puncture_ the tank, causing them to bleed for 10 seconds
_Thrash_ will cause him to attack 3 times in rapid succession
Razorlash has a _Cleave_. Avoid standing near the tank
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Maraudon: Earth Song Falls (Mara) 36-41 *Test*",[[
mapid 750
description This guide will walk you through the Maraudon: Earth Song Falls dungeon.
achieveid 640
author support@zygorguides.com
step
label	"start"
Press _I_ and queue for Maraudon: Earth Song Falls or enter the dungeon with your group |goto Maraudon/2 28.1,35.5 < 100 |c
step
...
Landslide will _Knock Away_ the tank, causing physical damage and knocking them back
Periodically, _Trample_ will deal physical damage to the entire party
During _Landslide_, all party members will be stunned while he summons 4 _Theradrim Shardlings_. Kill these and finish Landslide off
_Healer:_ Be prepared to heal the group during _Trample_
Defeat Landslide |scenariogoal 25056 |or |goto Maraudon/2 40.6,48.3
Start the scenario |confirm |or
step
map Maraudon/2
path loop off
...
Theradras will _Thrash_, dealing 2 extra attacks to the tank
_Repulsive Gaze_ will fear the tank and anyone standing near them for 6 seconds. Don't stand near the tank
Thrown _Boulders_ will deal damage to random players, interrupt spellcasting, and stun them for 2 seconds
_Dust Field_ will deal nature damage to anyone within 20 yards of Theradras and knock them back
_Healer:_ Be prepared for the group to take heavy damage during _Dust Field_
...
Rotgrip will _Puncture_ the tank for the entire fight, bleeding them for physical damage
_Fatal Bite_ will damage the tank and heal Rotgrip for twice the amount of damage dealt
Defeat Rotgrip |scenariogoal 25057 |goto 41.6,79.5
step
Congratulations, you have completed Maraudon: Earth Song Falls!
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Dire Maul: Warpwood Quarter (DM) 38-43 *Test*",[[
mapid 699
description This guide will walk you through the Dire Maul: Warpwood Quarter dungeon.
achieveid 644
author support@zygorguides.com
step
label "start"
Press _I_ and queue for Dire Maul: Warpwood Quarter or enter the dungeon with your group |goto Dire Maul/5 6.7,38.3 < 100 |c
step
...
talk Pusillin##14354
_Follow_ the path and talk to _Pusillin_ whenever he stops |goto 71.6,46.8 < 5 |c |noway
step
talk Pusillin##14354
...
_Void Bolt_ deals shadow damage to her current target
_Shadow Bolt Volley_ will deal AoE damage to the whole group
_Curse of Thorns_ has a 50% chance per melee attack to cause shadow damage to the player afflicted
_Curse of Tongues_ will slow the casting speed of anyone effected by 50%
_Immolate_ will apply a standard fire DoT
Lethtendris will _Enlarge_ Pimgib, increasing his damage
Burn down Pimgib and focus on Lethtendris
Interrupt _Shadow Bolt Volley_, _Curse of Thorns_, and _Curse of Tongues_
collect Lethtendris' Web##18426 |q Lethtendris's Web##27108/1 |goto 42.8,49.1 |only if havequest(27108)
Defeat Lethtendris |scenariogoal 25058 |or |goto 42.8,49.1
Start the scenario |confirm |or
step
map Dire Maul/5
path follow loose; loop off; ants curved; dist 10
...
_Submersion_ reduces the party's stamina by 10 per stack. Acts as a soft enrage
Move away from Hydrospawn when he uses _Riptide_. This will disarm and knock back anyone within 10 yards
Hydrospawn will _Summon Massive Geyser_, dealing frost damage to anyone standing in the geyser
At 50% health, he will summon 2 Hydrolings. These have a knockback and drop threat every time they land a hit. Kill them quickly
...
Players afflicted by _Intense Pain_ will deal shadow damage to anyone standing nearby
Occasionally, Thornhoof will _Sacrifice_ players on his altar. The sacrificed player will take heavy damage over 6 seconds
_Healer:_ You must heal the _Sacrifice_ target or they will die
...
_Satyr Form:_
Alzzin will leech mana from random players using _Enervate_
_Wither_ is a disease that deals nature damage and reduces strength by 50 for 21 seconds
_Tree Form:_
Alzzin will _Disarm_ and _Knock Away_ the tank. _Knock Away_ acts as a threat drop
_Wild Regeneration_ will heal Alzzin over 16 seconds
_Dire Wolf Form:_
_Mangle_ will slow the tank's movement speed by 50% and inflict a short bleed
At 50% health he will use _Come Minions!_, summoning imps which reset threat every time they hit. Kill them quickly
Defeat Alzzin the Wildshaper |scenariogoal 545 |goto Dire Maul/6,57.7,28.9
step
click Felvine Shard##5746
Click the Reliquary of Purity in your bags |use Reliquary of Purity##18539
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Scholomance (Scholo) 40-43 *Test*",[[
mapid 898
dungeondifficulty Normal
description This guide will walk you through the Scarlet Halls dungeon.
achieveid 645
...
only if not completedq(31440) and not completedq(31447)
step
...
_Phase 1:_
_Wrack Soul_ will deal damage to a party member and jump to a nearby party member when it expires. Spread out |only if heroic_dung()
_Touch of the Grave_ causes Chillheart's next 10 basic attacks to deal additional damage
_Frigid Grasp_ will summon ice at a player's feet, step out of this before it explodes
_Ice Wall_ will start at the back of the room and slowly creep toward the boss. If this touches any player, they will die instantly. This will act as the enrage timer of the fight
Kill Chillheart's physical body and Phase 2 will start
_Phase 2:_
The Anarchist Arcanist will float around creating _Arcane Bombs_. These explode on impact so avoid them
Antonidas' Self Help Guide to Standing in Fire will cast _Burn_. This does a small AoE of fire damage around the book
Wander's Colossal Book of Shadow Puppets will cast _Shadow Bolt_ at the party
Defeat Instructor Chillheart |scenariogoal 19259 |or |goto Scholomance/1 65.5,60.6
Start the scenario |confirm |or
step
click In the Shadow of the Light##6477
You can find the tome near this area
Destroy the tome "In the Shadow of the Light" |q The Four Tomes##31440/1 |goto 72.15,64.41
only if havequest(31440)
step
map Scholomance/1
path follow loose; loop off; ants curved
path	74.6,52.0	85.7,51.6	85.4,24.1
_Follow_ the path |goto Scholomance/1 85.4,24.1 < 5 |c |noway
step
click Kel'Thuzad's Deep Knowledge##6477
You can find the tome near this area
Destroy Kel'Thuzad's Deep Knowledge |q The Four Tomes##31440/2 |goto Scholomance/2 73.9,8.6
only if havequest(31440)
step
kill 1 Jandice Barov##59184 |goto Scholomance/2 58.8,18.3
_Wondrous Rapidity_ is a large cone attack in front of Jandice, make sure nobody is in front of her.
_Gravity Flux_ will create a gravity distortion field on the ground. If you step into this ability you will be knocked back as well as damaged heavily |only if heroic_dung()
At _66%_ and _33%_ Jandice will cast _Phantasmal Images_. She will clone herself throughout the room, destroy the clones until she returns to battle
Destroying the wrong clone will deal arcane damage to all party members |only if heroic_dung()
While the clones are alive they will cast _Whirl of Illusion_, this does AoE damage to everybody in the group every second.
Defeat Jandice Barov |scenariogoal 19260 |goto Scholomance/2 58.8,18.3
step
kill 1 Rattlegore##59153, Boneweaver##59193+ |goto Scholomance/2 48.6,26.7
Clearing all of the Boneweavers in the room will begin the Rattlegore encounter
With each successful attack Rattlegore will gain a stack of _Rusting_. This increases his attack damage but lowers his attack and movement speeds. If the tank is getting hit too hard, kite Rattlegore around the room
_Bone Spike_ will target a random party member and do massive damage to them. This can be prevented if every party member keeps _Bone Armor_ active
_Bone Armor_ is granted by clicking on the _Bone Piles_ around the room
Periodically a section of the room will be engulfed in _Soulflame_. Avoid the fire and be wary because it grows over time
...
You can find the tome near this area
Destroy Forbidden Rites and other Rituals Necromantic |q The Four Tomes##31440/3 |goto 36.0,47.1
only if havequest(31440)
step
map Scholomance/2
path follow loose; loop off; ants curved
path	39.6,47.5	46.4,47.2
_Follow_ the path |goto 46.4,47.2 |c |noway
step
kill 1 Lilian Voss##58722 |goto 51.4,47.1
_Phase 1:_
Lilian will _Shadow Shiv_ a random player after jumping onto them. Run away from allies
_Death's Grasp_ will pull every party member to Lilian and will be followed by _Dark Blaze_. _Dark Blaze_ causes every player to start leaving a trail of fire behind them. Kite fire away from allies
_Phase 2 (begins at 60%):_
She will periodically cast _Blazing Soul_ which does fire damage to all players.
For every melee attack Lilian lands she will unleash another _Blazing Soul_. Kite her around
If you are targetedy by _Fixate Anger_, run away
_Phase 3:_
Be watchful of who Lilian's Soul is _Fixating_ on, this is the highest source of damage during the fight
You will continue to be pulled in by _Death's Grasp_, keep an area clear of _Dark Blaze_
...
You can find the tome near this area
Destroy The Dark Grimoire |q The Four Tomes##31440/4 |goto Scholomance/2 47.1,73.1
only if havequest(31440)
step
map Scholomance/2
path follow loose; loop off; ants curved
...
_Immolate_ will be used on a random party member
Darkmaster Gandling will cast _Rise!_. This summons many _Failed Students_ that need to be killed. During this cast Darkmaster Gandling takes reduced damage
Periodically a random party member will be teleported to one of Gandling's study rooms for a _Harsh Lesson_
This party member must kill the _Expired Test Subjects_ and make their way back to the bosses room. If the healer gets trapped in one of these rooms, the _Fresh Test Subjects_ around the room will serve as useful bombs. Dispel the _Explosive Pain_ off of them to deal AoE damage
kill 1 Darkmaster Gandling##59080 |q An End to the Suffering##31447/1 |goto Scholomance/4 49.9,38.5 |only if havequest(31447)
Defeat Darkmaster Gandling |scenariogoal 19263 |goto Scholomance/4 49.9,38.5
step
talk Talking Skull##64562
turnin The Four Tomes##31440 |goto Scholomance/3 49.2,21.2
only if not completedq(31440)
step
talk Talking Skull##64562
turnin An End to the Suffering##31447 |goto Scholomance/3 49.2,21.2
only if not completedq(31447)
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Uldaman (Uld) 40-45 *Test*",[[
mapid 692
description This guide will walk you through the Uldaman dungeon.
achieveid 638
author support@zygorguides.com
...
Revelosh will use _Chain Lightning_, arcing to up to 2 additional targets. Interrupt this as often as possible
He will also use _Lightning Bolt_ on his primary target
Defeat Revelosh |scenariogoal 24971 |or |goto Uldaman 52.7,72.2
Start the scenario |confirm |or
step
map Uldaman/1
path follow loose; loop off; ants curved; dist 10
...
step
click the Keystone##1369 |goto 45.4,73.7
kill 1 Ironaya##7228 |goto 45.4,73.7 |only if default
_Arcing Smash_ is a frontal cone cleave attack. Don't stand in front of her
Periodically, Ironaya will _Knock Away_ her current target, dealing physical damage and knocking them back
_War Stomp_ will deal damage to everyone in melee range and stun them for 4 seconds
...
step
kill 1 Obsidian Sentinel##7023 |goto Uldaman/1 28.7,61.7
_Obsidian Reflection_ will give the Sentinel a 20% chance to reflect the next spell cast at him
Occasionally, the Sentinel will use _Splintered Obisian_. This lowers Obsidian Sentinel's damage and summons an _Obsidian Shard_
These Shards possess the same _Obsidian Reflection_ as the Sentinel
Obtain the Obsidian Power Core |q We Require More Minerals##27682/1 |goto Uldaman/1 28.7,61.7 |only if havequest(27682)
...
_Sand Storms_ will swirl towards random players, dealing physical damage and slowing them. Stay away from these
Retrieve the Titan Power Core |q We Require More Minerals##27682/2 |goto Uldaman/1 47.5,42.5 |only if havequest(27682)
...
Galgann will use _Fire Nova_, dealing fire damage to all players within 10 yards
_Amplify Flames_ will increase the damage the tank takes from his fire spells
He will randomly _Flame Lash_, stacking a fire DoT on players which decreases their fire resistance
Shadowforge Geologists will use _Flame Lash_ as well as _Flame Strike_, placing a pillar of fire on the ground. Avoid these areas
Interrupt the Geologists as often as possible. Kill them first and then kill Galgann
...
_Chain Bolt_ will arc to up to 3 targets, dealing nature damage
He will cast _Lightning Bolt_ on the tank
_Bloodlust_ will increase one of his minion's attack speed by 30%. Dispel this if possible
_Shrink_ is a curse that reduces the strength and stamina of anyone within 5 yards
The Jadespine Basilisk will use _Reflection_, reflecting spells for 5 seconds. Dispel this or have melee kill it
_Crystalline Slumber_ will stun the Basilisk's target and deal arcane damage
Kill the adds and then kill Grimlok
...
kill Archaedas##2748 |goto Uldaman/2 55.4,50.7 |only if default
Archaedas calls an _Earthen Custodian_ every 10 seconds to assist him
At 66% health, he will awaken 6 _Earthen Guardians_. These guardians will use _Whirlwind_, run away when they do this
At 33% health, he will awaken 2 _Vault Warders_. These warders will _Trample_ anyone within 10 yards for physical damage. Run away when they do this
Archaedas will occasionally _Ground Tremor_, stunning anyone within 20 yards
Kill the adds when they spawn, then switch back to Archaedas
kill Archaedas##2748 |q Archaedas, The Ancient Stone Watcher##27680/1 |goto Uldaman/2 55.4,50.7 |only if havequest(27680)
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Dire Maul: Capital Gardens (DM) 41-46 *Test*",[[
mapid 699
description This guide will walk you through the Dire Maul: Capital Gardens dungeon.
author support@zygorguides.com
step
label	"start"
Press _I_ and queue for Dire Maul: Capital Gardens or enter the dungeon with your group |goto Dire Maul/2 93.5,47.7 < 100 |c
step
talk Estulan##44991
...
Kalendris will randomly cast _Shadow Word: Pain_ or party members. Dispel this or heal through it
_Mind Flay_ will deal shadow damage to the target and reduce movement speed by 50%
_Mind Blast_ deals shadow damage to his current target
Occasionally he will use _Dominate Mind_ on a party member. CC or dispel the afflicted player
kill Magister Kalendris##11487 |q The Cursed Remains##27112/1 |goto Dire Maul/3,30.6,45.8 |only if havequest(27112)
Defeat Magister Kalendris |scenariogoal 25061 |or |goto Dire Maul/3,30.6,45.8
Start the scenario |confirm |or
step
map Dire Maul/3
path follow loose; loop off; ants curved; dist 10
...
Ferra will use _Charge_ on random players, dealing damage and stunning them. This will be followed by _Maul_, dealing physical damage
_Multi-Shot_ will hit players standing close to each other. Spread out
Areas targeted with _Volley_ will deal arcane damage to anyone standing within. Move out of it
Ravenoak will drop _Immolation Trap_ at her feet. Don't walk over these traps
_Concussive Shot_ will slow or stun random party members for 3 seconds
...
_Intruder Alert!_ will summon any _Ironbark Protectors_ left alive in the instance to Warpwood's side
Tendris will _Trample_ anyone within 10 yards, dealing physical damage
_Grasping Vines_ will deal damage to the party, knocking them down and preventing movement for 10 seconds. Dispel this if possible
If no player is within melee range, he will teleport a random person to him and _Entangle_ them for 10 seconds
...
_Eyes of Immol'thar_ cannot be tanked. Kill them quickly
_Portal of Immol'thar_ will teleport a random player and wipe their threat
Immol'thar will use _Infected Bite_ on the tank, increasing damage taken by a small amount and dealing nature damage. Dispel this disease
_Frenzy_ will cause Immol'thar to enrage, increasing his attack speed by 60% for 3 minutes
He will occasionally _Trample_, dealing physical damage to anyone standing within 10 yards
kill Immol'thar##11496 |q The Madness Within##27110/1 |goto 35.5,57.0 |only if havequest(27110)
Defeat Immol'thar |scenariogoal 546 |goto 35.5,57.0
step
map Dire Maul/4
path follow loose; loop off; ants curved; dist 10
...
_Healer:_ Price Tortheldrin attacks very quickly and is capable of dealing large amounts of burst damage
_Tank:_ Save defensive cooldowns in case the healer gets hit with _Counterspell_
Periodically he will _Thrash_, gaining 2 extra attacks
_Arcane Blast_ will deal damage to a random player and knock them back
Anyone within 8 yards of Tortheldrin will take damage from _Whirlwind_. Move away during this
He will also randomly _Counterspell_ players. This spell can be very dangerous for healers, as it will prevent spellcasting for 15 seconds
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Razorfen Downs (RFD) 42-47 *Test*",[[
mapid 760
description This guide will walk you through the Razorfen Downs dungeon.
achieveid 636
author support@zygorguides.com
...
only if not completedq(33513)
step
talk Koristrasza##74367
accept The Ritual##33514 |goto Razorfen Downs/1 28.2,24.3
only if not completedq(33514)
step
...
Aarux will use _Web Strand_, linking himself to a party member with sticky webbing. If he pulls the player close enough, he will use _Plagued Bite_. Run away from him
_Plagued Bite_ deals heavy nature damage to the target over 10 seconds
_Burning Pustule_ will deal nature damage to those close to Aarux
kill Aarux##74412 |q Blackthorn's Lieutenants##33513/3 |goto Razorfen Downs/1 58.9,33.7 |only if havequest(33513)
Defeat Aarux |scenariogoal 24954 |or |goto Razorfen Downs/1 58.9,33.7
Start the scenario |confirm |or
step
map Razorfen Downs/1
path follow loose; loop off; ants curved; dist 10
...
Mordresh will use _Lava Burst_ on the tank, dealing substantial fire damage. Interrupt this
Periodically, he will _Summon Blazing Servitor_. These need to be killed quickly so no more than 1 is up at a time
Servitors will use _Inferno_, spewing blobs of fire at random locations. Stay out of the impact points
If more than one servitor is active at a time they will use _Fiery Link_, connecting themselves together with a line of fire that deals massive damage to anyone touched by it
...
Mushlump will use _Smack Down_ on the tank, dealing increased physical damage over 3 seconds
_Tummy Ache_ will deal heavy nature damage to anyone standing in a cone in front of him
Clouds of _Putrid Funk_ will afflict a disease on anyone standing in them. Avoid coming in contact with these clouds
kill 1 Mushlump##74435 |q Blackthorn's Lieutenants##33513/1 |goto Razorfen Downs/1 41.9,43.4 |only if havequest (33513)
Defeat Mushlump |tip He patrols the ravine |scenariostage 1 |goto Razorfen Downs/1 41.9,43.4
step
map Razorfen Downs/1
path follow loose; loop off; ants curved; dist 10
...
path	49.2,64.2	49.5,56.9	43.7,53.4
path	40.9,53.9	40.1,62.1
...
_Summon Skeletons_ will animate 3 skeletons to assist Blackthorn
These skeletons will use _Disrupting Dash_, charging at someone and interrupting spellcasting; and _Shield Smash_, which cleaves to anyone near the target
_Shockwave_ will deal massive damage to anyone standing in a narrow cone in front of Blackthorn. Avoid this
_Searing Shadows_ will place a DoT on the tank, dealing shadow damage over 15 seconds. Interrupt or dispel this
Be sure to interrupt _Shadowmend_ to prevent Blackthorn from healing his skeletons
Defeat Death Speaker Blackthorn |scenariostage 2 |goto Razorfen Downs/1 44.7,59.7
step
kill Amnennar the Coldbringer##7358 |goto 44.6,59.4 |only if default
_Frozen Bomb_ appears as a patch of frost on the ground. Anyone standing within will suffer frost damage
Throughout the fight, Koristrasza will place green patches of _Redeemed Soil_
When you are afflicted with _Soul Leech_, run into a patch of _Redeemed Soil_ to remove the debuff and stun Amnennar for 6 seconds
kill Amnennar the Coldbringer##7358 |q The Ritual##33514/1 |goto 44.6,59.4 |only if havequest(33514)
Defeat Amnennar the Coldbringer |scenariostage 3 |goto Razorfen Downs/1 45.0,58.6
step
talk Koristrasza##74888
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Dire Maul: Gordock Commons (DM) 43-48 *Test*",[[
mapid 699
description This guide will walk you through the Dire Maul: Gordock Commons dungeon.
author support@zygorguides.com
step
...
_Important:_ Clear the ogres and hounds in the courtyard before engaging Guard Mol'dar
Mol'dar will randomly _Shield Charge_ players, dealing damage and knocking them back
_Strike_ is a physical attack used on the tank
_Shield Bash_ will interrupt any spell currently being cast. Avoid casting while standing near him or when hit with _Shield Charge_.
At 50% health, Mol'dar will use _Intruder Alert!_ - calling nearby mobs to assist him
He will call out for help, so you may need to clear some of the area around him first
...
_Booze Spit_ is a frontal cone attack that will reduce chance to hit by 75% and make you drunk for 8 seconds. Avoid standing in front of Kreeg
_War Stomp_ will knock back any player within 5 yards
Anyone within 8 yards is vulnerable to _Whirlwind_. Run away when he does this
At 50% health, Kreeg gains _Frenzy_ and _Drunken Rage_. This will cause him to attack 60% faster and move 100% faster
_Tank:_ Keep your back to a wall and save defensive cooldowns for the 50% enrage
...
_Important:_ Clear the ogres and hounds in the courtyard before engaging Guard Fengus
Fengus will randomly _Shield Charge_ players, dealing damage and knocking them back
_Strike_ is a physical attack used on the tank
_Shield Bash_ will interrupt any spell currently being cast. Avoid casting while standing near him or when hit with _Shield Charge_.
At 50% health, Fengus will use _Intruder Alert!_ - calling nearby mobs to assist him
He will call out for help, so you may need to clear some of the area around him first
...
_Important:_ Clear the ogres nearby before engaging Guard Slip'kik
Slip'kik will randomly _Shield Charge_ players, dealing damage and knocking them back
_Strike_ is a physical attack used on the tank
_Shield Bash_ will interrupt any spell currently being cast. Avoid casting while standing near him or when hit with _Shield Charge_.
At 50% health, Slip'kik will use _Intruder Alert!_ - calling nearby mobs to assist him
He will call out for help, so you may need to clear some of the area around him first
...
Keep Kromcrush away from the area in which he stands. He will use _Frightening Shout_, fearing anyone within 8 yards for 6 seconds
_Mortal Cleave_ will hit a melee target and another standing near them, reducing healing by 50%
At 50% health, Kromcrush will use _Intruder Alert!_, calling 2 Gordok Reavers to aid him. CC or kill these first
These reavers will use _Cleave_, _Sunder Armor_, and _Mortal Strike_
At 25% health, Kromcrush will activate _Retaliation_ for 8 seconds, instantly striking anyone hitting him in melee combat
_DPS:_ Do not attack Kromcrush during Retaliation
_Healer:_ Be aware that the healing reducting effects on this fight will require to you heal more frequently
...
Cho'Rush can spawn as a _Priest_, _Shaman_, or _Mage_
Interrupt Cho'Rush when he casts _Heal_, _Healing Wave_, or _Arcane Explosion_
Dispel his _Power Word: Shield_ and _Bloodlust_
_King Gordok:_
_Berserker Charge_ will deal damage to random players and knock them up in the air
The tank will take more damage as the fight progresses thanks to stacks of _Sunder Armor_
_Mortal Strike_ will reduct healing on the tank by 50%
The King will use _War Stomp_ on anyone within 5 yards, dealing damage and stunning for 4 seconds
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Dungeon Guides\\Classic Dungeons\\Stratholme: Main Gate (Strat) 44-49 *Test*",[[
mapid 765
description This guide will walk you through the Stratholme: Main Gate dungeon.
author support@zygorguides.com
step
label	"start"
Press _I_ and queue for Stratholme: Main Gate |confirm |or
Or
Enter the dungeon with your group |goto Stratholme/1 68.0,88.5 < 100 |c |or
step
...
kill 1 Fras Siabi##11058 |goto 54.5,70.8 |tip He will show up after you click the box.
click Premium Siabi Tobacco##336
...
Be prepared, 3 Undead Postman will appear and attack the party
confirm
step
map Stratholme/1
path follow loose; loop off; ants curved; dist 10
...
Open the King's Square Postbox. Be prepared, 3 Undead Postman will appear and attack the party
confirm
step
map Stratholme/1
path follow loose; loop off; ants curved; dist 10
...
Occasionally, Forresten will put a player to sleep with _Enchanting Lullaby_. Interrupt him or dispel the debuff
_Demoralizing Shout_ will reduce the melee attack power of anyone within 10 yards
_Shoot_ will hit random party members for minor physical damage
Spread out to avoid excessive damage from _Multi-Shot_
_DPS:_ Stay behind him while you DPS to avoid the 50% increased dodge chance he gains from _Incorporeal Defense_
...
step
kill The Unforgiven##10516 |goto 73.6,20.4 |only if default
_Unrelenting Anguish_ is a channeled attack that deals heavy shadow damage over 5 seconds. Interrupt this
The Unforgiven is accompanied by 4 _Vengeful Phantoms_. These phantoms will use _Frost Shock_, dealing frost damage and slowing movement speed
Clean up the phantoms and kill The Unforgiven
...
Click the Market Row Postbox. Be prepared, 3 Undead Postman and _Postmaster Malown_ will appear and attack the party
Malown will _Backhand_ the tank, stunning them for 2 seconds
Be sure to keep him away from any packs of mobs, as he will _Fear_ a player occasionally
_Curse of Tongues_ will slow spellcasting by 50% on any player afflicted. Dispel this when possible
...
step
kill Timmy the Cruel##10808 |goto Stratholme 50.1,17.4 |only if default
Timmy will gain extra attacks through _Thrash_
_Ravenous Claw_ will heal Timmy for the damage he deals with it
At 50% health, timmy will _Enrage_. This will increase his damage dealt by 10% and his attack speed by 30%
_Tank:_ Save defensive cooldowns for _Enrage_
...
_Ground Smash_ will deal physical damage to anyone within 10 yards and stun them for 2 seconds
_Head Crack_ will reduce the tank's stamina for 15 seconds
Interrupt _Shadow Bolt Volley_ so it doesn't deal damage to the entire group
...
step
click Blacksmithing Plans##525
The Hammersmith has only one ability - _Bone Smelt_
This will deal heavy fire damage to his current target and reduce their armor by 50% for 20 seconds
...
Every 5 seconds, Willey will _Summon Risen Riflemen_. You must gather Scarlet Cannonballs and use the Scarlet Cannons to kill them
_Knock Away_ will deal damage to the tank and knock him back
He will occasionally _Pummel_ anyone standing close, interrupting any spell being cast and dealing physical damage
...
click Unfinished Painting##4733 |tip This is on the wall next to you.
_Fire Nova_ will deal damage to anyone within 10 yards
Galford will use _Pyroblast_ on the tank, dealing heavy fire damage and ticking for additional damage over 12 seconds
Occasionally, the tank will be hit with _Burning Winds_. This will deal fire damage and stun for 5 seconds. Dispel
get Of Love and Family |q Of Love and Family##27305/1 |goto 27.4,76.2 |only if havequest(27305)
Defeat Instructor Galford |scenariogoal 24917 |goto 27.4,75.2
step
kill 1 Balnazzar##10813 |only if default
_Mind Blast_ will deal shadow damage to his current target
_Shadow Shock_ will hit the entire group with shadow damage
Randomly, Balnazzar will use _Domination_ on a player, mind controlling them for 8 seconds
He will also randomly _Sleep_ players, lasting 6 seconds
Anyone within 8 yards is succeptible to _Psychic Scream_. This causes players to flee for 4 seconds
kill 1 Balnazzar##10813 |q The Dreadlord Balnazzar##27208/1 |goto 19.3,83.1 |only if havequest(27208)
Defeat Balnazzar |scenariogoal 550 |goto 19.3,83.1
step
talk Crusade Commander Eligor Dawnbringer##45200
