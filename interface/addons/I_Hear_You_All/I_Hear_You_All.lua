local sounds = {
	...
	["CHAT_MSG_PARTY_GUIDE"] = "Interface\\AddOns\\I_Hear_You_All\\party.ogg", MASTER,
	["CHAT_MSG_BN_CONVERSATION"] = "Interface\\AddOns\\I_Hear_You_All\\party.ogg", MASTER,
...
f:SetScript("OnEvent", function(self, event)
	PlaySoundFile(sounds[event], "Master")
end)