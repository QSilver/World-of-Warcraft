...
L["Shine"] =  true
L["Set color for expire time shine effect (set invisible opacity to disable showing shine effect)."] = true
L["Combat Text"] = true
...
L["Shine When Expiring"] = true
L["Enable shine effect for expiring bars."] = true
L["Shine Color"] = true
L["Set color for expire time shine effect."] = true
