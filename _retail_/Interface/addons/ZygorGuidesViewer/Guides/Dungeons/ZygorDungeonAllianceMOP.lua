...
Tell it: _"It's Safe to come out now."_ |q No Man Left Behind##30995/1 |count 2 |goto 65.0,70.8
only if not completedq(30995)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
Tell it: _"It's Safe to come out now."_ |q No Man Left Behind##30995/1 |count 4 |goto 52.0,26.2
only if not completedq(30995)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
kill 1 Glubtok##47162 |q The Foreman##27756/1 |goto 37.7,61.2 |only if havequest(27756)
Phase 1:
...
Open the door and walk inside |goto 43.7,81.6 < 5 |c |only if default
Open the door and walk inside |condition havequest(27758) |goto 43.8,80.5 |only if not completedq(27758)
step
kill 1 Helix Gearbreaker##47296 |n |goto 49.0,87.4 |only if default
kill 1 Helix Gearbreaker##47296 |q The Carpenter##27758/1 |goto 49.0,87.4 |only if havequest(27758)
Phase 1:
...
step
click Heavy Door##400
Open the door and walk inside |goto 61.0,73.6 < 5 |c |only if completedq(27781)
Open the door and walk inside |condition havequest(27781) |goto 61.0,73.6 |only if not completedq(27781)
step
kill 1 Foe Reaper 5000##43778 |n |goto 10.4,82.8 |only if default
kill 1 Foe Reaper 5000##43778 |q The Machination##27781/1 |goto 10.4,82.8 |only if havequest(27781)
...
Use the cannon to blow open the door and walk inside |goto The Deadmines/2 33.4,48.9 < 8 |c |noway |only if completedq(27785)
Use the cannon to blow open the door and walk inside |condition havequest(27785) |goto The Deadmines/2 33.4,48.9 |only if not completedq(27785)
step
map The Deadmines/2
path follow loose; loop off; ants curved
...
kill 1 Admiral Ripsnarl##47626 |q The Admiral##27785/1 |goto 63.9,39.5 |only if havequest(27785)
...
step
kill 1 "Captain" Cookie##47739 |n |goto 63.9,39.5 |only if completedq(27790)
kill 1 "Captain" Cookie##47739 |q The Defias Kingpin##27790/1 |goto 63.9,39.5 |only if not completedq(27790)
...
step
label	"start"
goto Searing Gorge/0 34.2,88.3
.talk 10299
..accept 27440
step
