...
Open your Alchemy window if you have already trained |cast Alchemy##2259
step
#include "home_ValleyofStrength"
step
#include "auctioneer"
buy 54 Peacebloom##2447
buy 54 Silverleaf##765
...
collect 54 Peacebloom##2447
collect 54 Silverleaf##765
step
label "alch_1-55_skill"
title Alchemy 1-55
#include "vendor_Alchemy"
buy 54 Crystal Vial##3371 |tip You can buy more just in case.
step
...
#include "trainer_Alchemy"
skillmax Alchemy,150 |goto 55.7,45.8 |tip You must be at least level 10.
learn Lesser Healing Potion##2337
step
You will need the 38 _Minor Healing Potions_ that you saved from previous steps in this section.
collect 38 Minor Healing Potion##118 |n
confirm
step
#include "auctioneer"
...
buy 75 Crystal Vial##3371 |only if itemcount("Minor Healing Potion")>=38
step
...
step
You don't need to save anything from the Journeyman Alchemy section to use in the Expert portion.
...
Open your Alchemy window before moving onward |cast Alchemy##2259
confirm
step
title + Alchemy 125-215
#include "auctioneer"
...
step
You don't need to save anything from the Expert Alchemy section to use in the Artisan portion.
Feel free to sell off anything you might have created and you may also sell off any left over materials from this section.
confirm
step
#include "auctioneer"
...
path 72.1,57.3		75.7,57.0		77.1,48.2
path 73.3,50.2
#include follow_path_herbs
...
step
You don't need to save anything from the Artisan Alchemy section to use in the Master portion.
Feel free to sell off anything you might have created and you may also sell off any left over materials from this section.
confirm
step
#include "auctioneer"
buy 50 Golden Sansam##13464
buy 17 Mountain Silversage##13465
...
#include follow_path_herbs
collect 17 Mountain Silversage##13465 |tip These can be found tucked away in the sides of mountains, so keep an eye out for them.
...
step
You don't need to save anything from the Master Alchemy section to use in the Grand Master portion.
Feel free to sell off anything you might have created and you may also sell off any left over materials from this section.
confirm
step
#include "auctioneer"
...
step
You will use the _Frost Lotus, Lichbloom and Goldclovers_ that you gathered from the Grand Master Alchemy section in the Illustrious Grand Master portion of the guide.
collect 10 Frost Lotus##36908 |n
confirm
step
#include "auctioneer"
...
create 1 Volatile Alchemist Stone##96252,Alchemy,505
step
...
path +	54.8,19.0	50.0,17.2	44.2,23.6
#include "follow_path_mine"
collect 100 Copper Ore##2770 |only if itemcount("Copper Bar")<60
collect 40 |only if itemcount("Copper Bar")>=60
#include "max_skill_warning",skill="Mining",goto="bla_1-75_farm"
step
label "farm2"
map Ashenvale
...
step
#include "maincity_forge2"
create Tin Bar##3304,Mining,45 total |n
...
You will need at least 20 _Copper Bars_, 10 _Tin Bars_ and 30 _Coarse Grinding Stones_.
collect 20 Copper Bar##2840 |n
collect 15 Tin Bar##3576 |n
collect 30 Coarse Grinding Stone##3478 |n
confirm
step
#include "auctioneer"
buy 165 Heavy Stone##2838
...
path +	54.8,19.0	50.0,17.2	44.2,23.6
#include "follow_path_mine"
collect 20 Copper Ore##2770 |only if itemcount("Copper Bar")<20
...
talk Tamar##3366
buy 35 Green Dye##2605 |goto Orgrimmar/1 60.3,54.3
step
#include "trainer_Blacksmithing"
...
collect 200 Mageweave Cloth##4338 |goto 49.2,87.0
You can find more:
Around [38.4,67.6]
Around [39.4,58.4]
step
...
collect 110 Fel Iron Bar##23445 |tip Hold on to 50 of these for the next section, you will need them.
next "bla_300-325_skill2"
step
label "bla_300-325_skill2"
talk 16583
buy Plans: Lesser Ward of Shielding##23638 |goto Hellfire Peninsula,53.2,38.2 |tip Save this recipe, you will learn it later, when your Blacksmithing skill is higher.  This recipe is a limited supply item, so if it's not available for purchase, keep checking again every few minutes until you can buy it.
step
talk 16583
learn Fel Iron Plate Gloves##29545 |goto 53.2,38.2
step
create Fel Iron Plate Gloves##29545,Blacksmithing,310 |goto 53.1,38.1
step
talk 16583
learn Fel Iron Plate Belt##29547 |goto 53.2,38.2
step
create Fel Iron Plate Belt##29547,Blacksmithing,315 |goto 53.1,38.1
step
talk 16583
learn Fel Iron Chain Gloves##29552 |goto 53.2,38.2
step
create Fel Iron Chain Gloves##29552,Blacksmithing,320 |goto 53.1,38.1
step
talk 16583
learn Fel Iron Plate Boots##29548 |goto 53.2,38.2
step
create Fel Iron Plate Boots##29548,Blacksmithing,325 |goto 53.1,38.1
step
Keep any Fel Iron that you have left over
confirm
step
label	"bla_325-350"
#include "shatt_auctioneer"
buy 106 Adamantite Bar##23446
...
buy 1 Plans: Adamantite Cleaver##23591 |n |goto Shattrath City,64.1,71.9 |tip This recipe is a limited supply item, so if it's not available for purchase, keep checking again every few minutes until you can buy it.
...
path	40.8,20.8	32.9,32.8	35.5,37.4
path	29.7,38.5
...
path	73.3,57.4	69.4,58.3	64.2,53.5
...
path	71.3,63.8
#include "follow_path_mine"
collect 594 Saronite Ore##36912
#include "max_skill_warning",skill="Mining",goto="bla_350-425_farm"
step
#include "trainer_Mining"
skillmax Mining,525
...
collect 297 Saronite Bar##36913
step
...
path 68.5,37.9
#include "follow_path_mine"
collect 200 Elementium Ore##52185
...
step
#include "maincity_anvil"
create Obsidium Bar##84038,Mining,36 total
collect 38 Obsidium Bar##54849
step
#include "maincity_anvil"
create Elementium Bar##74530,Mining,100 total |n
collect 100 Elementium Bar##52186
step
...
step
talk 50375
buy Plans: Vicious Pyrium Gauntlets##66118 |n |goto Twilight Highlands 77.3,53.1
...
step
talk 50375
buy 1 Plans: Vicious Pyrium Belt##66119 |n |goto 77.3,53.1
...
step
talk 50375
buy Plans: Vicious Ornate Pyrium Shoulders##66129 |n goto 77.3,53.1
...
buy 1 Recipe: Smoked Bear Meat##6892 |goto Silverpine Forest 43.2,40.6
step
...
collect 30 Crawler Meat##2674 |goto Ashenvale,13.0,29.2
...
step
talk Nerrist##1148
buy 1 Recipe: Curiously Tasty Omelet##3682 |goto Northern Stranglethorn 39.2,51.0
buy 1 Recipe: Roast Raptor##12228 |goto Northern Stranglethorn 39.2,51.0
step
...
collect 50 Raptor Egg##3685 |goto Northern Stranglethorn,30.8,31.6
collect 50 Raptor Flesh##12184 |goto Northern Stranglethorn,30.8,31.6 |opt
More can be found at the following location |goto 36.5,44.4
As well as here |goto 53.6,46.3
step
from Jungle Stalker##687+
collect 50 Raptor Flesh##12184 |goto 53.6,46.3
...
step
talk Himmik##11187
buy 1 Recipe: Monster Omelet##16110 |goto Winterspring,59.8,51.6
step
#include "auctioneer"
...
collect 40 Bear Flank##35562 |goto Winterspring 55.8,36.6
...
collect 25 Giant Egg##12207 |goto Winterspring 65.2,76.6
step
...
step
talk Arugi##46709
buy 1 Recipe: Juicy Bear Burger##35566 |goto Orgrimmar,56.2,61.6
step
...
step
talk Calandrath##15174
turnin Sharing the Knowledge##8313 |goto 55.5,36.8
step
from Dredge Crusher##11741+
collect 15 Sandworm Meat##20424 |goto 49.1,46.1
You can also get them off Dredge Strikers at this location |goto 54.1,57.8
step
#include "cooking_fire"
create 15 Smoked Desert Dumplings##24801,Cooking,300
step
talk Cookie One-Eye##16585
buy 1 Recipe: Ravager Dog##27688 |goto Hellfire Peninsula,54.6,41.2
step
...
collect 30 Ravager Flesh##27674 |goto Hellfire Peninsula,22.5,65.1
step
label "farm2"
Skipping 2nd part of farming |next "+exit" |only if step:Find("+farming"):IsComplete()
Proceeding to farm |next |only if default
...
collect 30 Talbuk Venison##27682 |goto Nagrand 52.2,44.4
step
...
accept Northern Cooking##13090 |goto Borean Tundra 42.0,54.2 |tip This quest is only available to you if you have 350+ Cooking skill.
step
from Wooly Rhino Matriarch##25487+, Wooly Rhino Calf##25488+, Wooly Rhino Bull##25489+
get 4 Chilled Meat |q 13088/1 |goto Borean Tundra,46.7,43.6
step
talk Orn Tenderhoof##26972
turnin Northern Cooking##13090 |goto 42.0,54.2
step
...
get Orange |q 12634/1 |goto 37.6,61.8
get 2 Banana Bunch|q 12634/2 |goto 37.6,61.8
get Papaya |q 12634/3 |goto 37.6,61.8
step
talk Grimbooze Thunderbrew##29157
...
get Thunderbrew's Jungle Punch|q 12644/1 |goto 26.7,60
step
talk Grimbooze Thunderbrew##29157
...
accept Fletcher's Lost and Found##13571 |instant |goto Dalaran,43.2,24.4
step
talk Applebough##29547
buy 50 Savory Snowplum##35948 |goto 43.1,57.0
buy 100 Tundra Berries##35949 |goto 43.1,57.0
step
...
collect 24 Chilled Meat##43013 |goto Borean Tundra,46.7,43.6
collect 16 Rhino Meat##43012 |goto Borean Tundra,46.7,43.6
step
...
step
talk Misensi##31031
buy 1 Recipe: Blackened Worg Steak##43032 |goto Dalaran,70.2,37.2
step
...
collect 25 Worg Haunch##43011 |goto Howling Fjord 30.8,62.6
step
...
collect 25 Toughened Flesh##62778 |goto Mount Hyjal,28.2,30.8
step
...
learn Whitecrest Gumbo##88047 |goto Orgrimmar,56.9,62.7
step
#include "auctioneer"
...
collect 62 Blood Shrimp##62791 |goto Kelp'thar Forest,49.1,28.0
step
...
learn Hearty Seafood Soup##88021 |goto 56.9,62.7
step
#include "cooking_fire"
...
label "cook_500-525"
talk Shazdar##49737
buy 1 Recipe: Grilled Dragon##65428 |goto 56.9,62.7
step
...
collect 35 Dragon Flank##62782 |goto Twilight Highlands,63.2,76.2
step
...
collect 112 Strange Dust##10940 |goto Wailing Caverns 45.8,59.7
collect 1 Lesser Magic Essence##10938 |goto Wailing Caverns 45.8,59.7
...
collect 9 Greater Magic Essence##10939 |goto Wailing Caverns 45.8,59.7
step
...
collect 25 Lesser Astral Essence##10998 |goto Blackfathom Deeps 44.29,10.66
step
...
collect 60 Soul Dust##11083 |goto Razorfen Kraul 69.89,82.97
...
Disenchant any uncommon quality (green) armor and weapons you loot. |cast Disenchant##13262
collect 20 Lesser Mystic Essence##11134 |goto Razorfen Downs 23.79,18.80
collect 40 Vision Dust##11137 |goto Razorfen Downs 23.79,18.80
...
step
create 10 Enchant Bracer - Lesser Strength##13536,Enchanting,165 |tip You can keep enchanting the same item repeatedly.
step
#include "trainer_Enchanting"
...
step
talk Kor'geld##3348
buy 20 Crystal Vial##3371 |goto Orgrimmar,55.3,46.1
step
#include "auctioneer"
buy 15 Lesser Nether Essence##11174
buy 200 Dream Dust##11176
...
collect 200 Dream Dust##11176 |goto Razorfen Downs 23.79,18.80 |tip You can also find Dream Dust by disenchating items in the Zul'Farrak dungeon.
collect 115 Vision Dust##11137 |goto Razorfen Downs 23.79,18.80
collect 15 Lesser Nether Essence##11174 |goto Razorfen Downs 23.79,18.80
collect 5 Greater Nether Essence##11175 |goto Razorfen Downs 23.79,18.80
step
...
collect 60 Lesser Eternal Essence##16202 |goto Blackrock Spire/4 26.77,38.23
step
...
collect 195 Arcane Dust##22445 |goto The Shattered Halls/1 61.14,92.81
collect 40 Lesser Planar Essence##22447 |goto The Shattered Halls/1 61.14,92.81
collect 20 Greater Planar Essence##22446 |goto The Shattered Halls/1 61.14,92.81
collect 10 Large Prismatic Shard##22449 |goto The Shattered Halls/1 61.14,92.81
step
...
collect 220 Infinite Dust##34054 |goto Halls of Lightning 7.38,53.81
collect 11 Greater Cosmic Essence##34055 |goto Halls of Lightning 7.38,53.81
step
label "farm2"
Proceeding to farm |next |only if default
step
...
collect 5 Crystallized Water##37705 |goto Wintergrasp,77.4,41.9
You can find more at |goto 64.2,58.8
You can find more at |goto 44.2,56.7
You can find more at |goto 28.9,50.3
step
...
step
#include "trainer_Enchanting"
learn Enchant Gloves - Haste##44484
step
...
collect 342 Hypnotic Dust##52555 |goto The Vortex Pinnacle 54.12,16.81
...
Disenchant any uncommon quality (green) armor and weapons with an item level of 272-305 and 305-333.|cast Disenchant##13262
collect 5 Lesser Celestial Essence##52718 |goto The Stonecore 54.27,93.90
collect 41 Greater Celestial Essence##52719 |goto The Stonecore 54.27,93.90
step
...
step
#include "trainer_Enchanting"
learn Enchant Gloves - Greater Haste##74220
step
create 5 Enchant Gloves - Greater Haste##74220,Enchanting,490 |tip You can keep enchanting the same item repeatedly.
step
#include "trainer_Enchanting"
...
label "ench_500-525"
#include "auctioneer"
buy 201 Hypnotic Dust##52555
buy 97 Greater Celestial Essence##52719
#include "go_disenchant",skill="Enchanting",req="1",goto="ench_426-500_farm"
...
Run through the Vortex Pinnacle dungeon, killing all mobs along the way.
Disenchant any uncommon quality (green) armor and weapons with an item level of 272-305 and 305-333.|cast Disenchant##13262
collect 201 Hypnotic Dust##52555 |goto The Vortex Pinnacle 54.12,16.81
collect 97 Greater Celestial Essence##52719 |n
step
Run through the Stonecore dungeon, killing all mobs along the way.
Disenchant any uncommon quality (green) armor and weapons with an item level of 272-305 and 305-333.|cast Disenchant##13262
collect 97 Greater Celestial Essence##52719 |goto The Stonecore 54.27,93.90
step
...
step
#include "trainer_Enchanting"
learn Enchant Bracer - Greater Haste##74239
step
create 9 Enchant Bracer - Greater Haste##74239,Enchanting,525 |tip You can keep enchanting the same item repeatedly.
step
...
step
Be sure to hold on to an _Arclight Spanner_ that you made in the previous section.
confirm
step
#include "auctioneer"
buy 20 Coarse Stone##2836
buy 14 Linen Cloth##2589
...
collect 5 Linen Cloth##2589 |goto Westfall,50.8,53.0
step
label "farm2"
Skipping 2nd part of farming |next "+exit" |only if step:Find("+farming"):IsComplete()
Proceeding to farm |next |only if default
...
step
You will need the 5 _Bronze Tubes_ that you saved from previous steps in this section.
You will also need the 40 _Bronze bars_ that you gathered from the previous section.
collect 5 Bronze Tube##4371 |n
collect 40 Bronze Bar##2841 |n
confirm
step
talk Auctioneer Drezmit##44866
buy 20 Heavy Stone##2838 |goto Orgrimmar 54.1,73.3
buy 51 Iron Bar##3575 |goto Orgrimmar 54.1,73.3
buy 25 Wool Cloth##2592 |goto Orgrimmar 54.1,73.3
buy 132 Solid Stone##7912 |goto Orgrimmar 54.1,73.3
buy 206 Mithril Bar##3860 |goto Orgrimmar 54.1,73.3
buy 22 Mageweave Cloth##4338 |goto Orgrimmar 54.1,73.3
buy 4 Steel Bar##3859 |goto Orgrimmar 54.1,73.3
buy 20 Gold Bar##3577 |goto Orgrimmar 54.1,73.3
...
collect 25 Wool Cloth##2592 |goto Ashenvale 35.6,32.7
step
label "farm2"
Skipping 2nd part of farming |next "+farm3" |only if step:Find("+farming"):IsComplete()
Proceeding to farm |next |only if default
...
collect 206 Mithril Ore##3858
collect 20 Gold Ore##2776
#include "max_skill_warning",skill="Mining",goto="eng_130-210_farm"
step
label "exit"
from Deadwood Gardener##7154+, Deadwood Warrior##7153+, Deadwood Pathfinder##7155+
from Jadefire Rogue##7106+, Jadefire Shadowstalker##7110+
from Jaedenar Cultist##7112+, Jaedenar Guardian##7113+, Jaedenar Adept##7115+
collect 22 Mageweave Cloth##4338 |goto Felwood,49.2,87.0
You can find more:
Here |goto 38.4,67.6
As well as here |goto 39.4,58.4
step
talk Shimra##5817
buy 4 Coal##3857 |goto Orgrimmar,54.0,81.9
step
#include "maincity_anvil"
create Iron Bar##3307,Mining,36 total
create Steel Bar##3569,Mining,4 total
create Mithril Bar##10097,Mining,206 total
create Gold Bar##3308,Mining,20 total
step
...
step
create 66 Solid Blasting Powder##12585,Engineering,66 total |n
skill Engineering,195
collect 66 Solid Blasting Powder##10505 |tip You will need to keep 66 Solid Blasting Powder to make items later.
step
#include "trainer_Engineering"
...
step	label  "eng_210-280"
#include "trainer_Engineering"
skillmax Engineering,300 |tip You must be at least level 35.
learn Unstable Trigger##12591
You will need the 66 _Blasting Powder_ that you saved from previous steps.
You will also need to save the _Mithril Bars_ from the previous section.
collect 66 Solid Blasting Powder##10505 |n
confirm
step
...
step
create 44 Mithril Casing##12599+,Engineering,44 total |tip Save 44 Mithril Casings in your bags, you will need them later to create items.
...
collect 35 Runecloth##14047 |goto Silithus,45.8,38.2
You can find more:
...
#include "maincity_anvil"
create Thorium Bar##16153,Mining,180 total
step
...
collect 18 Netherweave Cloth##21877 |goto Nagrand,73.3,69.7
step
label "farmthorium"
map Silithus
path	54.8,26.8	52.3,22.8	50.5,15.3
...
collect 44 Fel Iron Bolt##23783
...
buy 1 Schematic: White Smoke Flare##23811 |goto Shattrath City,72.2,30.7
step
...
step
From this point on, you won't need to save materials from previous sections for the next.
confirm
step
#include "auctioneer"
buy 200 Cobalt Bar##36916
buy 47 Crystallized Water##37705
buy 13 Crystallized Earth##37701
buy 194 Saronite Bar##36913
...
path 77.2,60.8	74.9,55.3	79.1,50.4
#include "follow_path_mine"
collect 200 Cobalt Ore##36909
collect 47 Crystallized Water##37705
...
#include "follow_path_mine"
collect 388 Saronite Ore##36912
collect 13 Crystallized Earth##37701
#include "max_skill_warning",skill="Mining",goto="eng_350-425_farm"
step
from Dark Ritualist##34734+,Dark Zealot##34728+
collect 6 Frostweave Cloth##33470 |goto Icecrown,61.8,20.8
step
from Ice Revenant##26283+
collect 56 Crystallized Water##37705 |goto Dragonblight 67.2,52.2
step
#include "trainer_Mining"
learn Smelt Saronite##49258
step
#include "maincity_anvil"
create Saronite Bar##49258,Mining,194 total
create Cobalt Bar##49252,Mining,200 total
step
...
collect 20 Embersilk Cloth##53010 |goto Mount Hyjal 60.0,70.8
step
map Twilight Highlands
path 71.4,50.3	54.0,37.6	41.3,56.6
path 37.5,58.2	24.5,56.9	30.0,42.8
...
#include "max_skill_warning",skill="Mining",goto="eng_425-500_farm"
step
from Obsidian Stoneslave##47226+ |tip If you have mining, you can get it from the corpse.
collect 52 Volatile Earth##52327+ |goto Twilight Highlands,57.9,31.2
step
from Enslaved Tempest##46328+
collect 72 Volatile Air##52328 |goto 34.6,69.2
...
#include "maincity_anvil"
create Handful of Obsidium Bolts##84403,Engineering,442	|tip You will need to keep at least 36 for upcoming recipes.
step
#include "trainer_Engineering"
...
step
from Twilight Augur##40713+, Twilight Retainer##40767+
collect 60 Embersilk Cloth##53010 |goto Mount Hyjal 60.0,70.8
step
from Flame Terror##52219+, Brimstone Destroyer##52794+, Charred Invader##52816+
collect 18 Volatile Fire##52325 |goto Mount Hyjal 20.0,58.6
step
map Twilight Highlands
path 71.4,50.3	54.0,37.6	41.3,56.6
path 37.5,58.2	24.5,56.9	30.0,42.8
...
collect 68 Volatile Earth##52327 |goto Twilight Highlands,57.9,31.2
step
from Enslaved Tempest##46328+
collect 24 Volatile Air##52328 |goto 34.6,69.2
You can find more over here |goto 39.5,85.7
step
#include "maincity_anvil"
...
collect 160 Linen Cloth##2589 |goto Durotar,47.4,48.9
step
...
from Thistlefur Shaman##3924+,Thistlefur Avenger##3925,Thistlefur Wise One##33389+,Thistlefur Warrior##33390+,Thistlefur Pathfinder##3926+
collect 75 Wool Cloth##2592 |goto Ashenvale,34.0,39.8
step
...
collect 90 Silk Cloth##4306 |goto Desolace 30.6,54.6
step
...
from Jadefire Rogue##7106+, Jadefire Shadowstalker##7110+
from Jaedenar Cultist##7112+, Jaedenar Guardian##7113+, Jaedenar Adept##7115+
collect 50 Mageweave Cloth##4338 |goto Felwood,49.2,87.0
step
...
from Twilight Keeper Havunth##11804+, Twilight Geolord##11881+, Twilight Avenger##11880+, Twilight Stonecaller##11882+
collect 80 Runecloth##14047 |goto Silithus 45.8,38.2
You can find more:
Around |goto 35.7,32.5
Around |goto 29.5,73.4
Around |goto 66.1,20.3
...
collect 50 Netherweave Cloth##21877 |goto Netherstorm,26.3,68.1
step
...
from Dark Ritualist##34734+, Dark Zealot##34728+
collect 80 Frostweave Cloth##33470 |goto Icecrown,61.8,20.8
step
...
from Twilight Augur##40713+, Twilight Retainer##40767+
collect 75 Embersilk Cloth##53010 |goto Mount Hyjal,35.0,24.0
step
...
step
.' You don't need to save anything from the Journeyman Inscription section to use in the Expert portion.
..' Feel free to sell off anything you might have created and you may also sell off any left over materials from this section.
|confirm
step
#include "vendor_Inscription"
...
step
.' You don't need to save anything from the Expert Inscription section to use in the Artisan portion.
..' Feel free to sell off anything you might have created and you may also sell off any left over materials from this section.
|confirm
step
#include "vendor_Inscription"
...
step
.' You don't need to save anything from the Artisan Inscription section to use in the Master portion.
..' Feel free to sell off anything you might have created and you may also sell off any left over materials from this section.
|confirm
step
#include "auctioneer"
...
step
.' You don't need to save anything from the Master Inscription section to use in the Grand Master portion.
..' Feel free to sell off anything you might have created and you may also sell off any left over materials from this section.
|confirm
step
goto 49.6,74.9
...
step
.' You don't need to save anything from the Grand Master Inscription section to use in the Illustrious Grand Master portion.
..' Feel free to sell off anything you might have created and you may also sell off any left over materials from this section.
|confirm
step
#include "auctioneer"
...
step
'Skipping next part of farming |next "exit" |only if step:Find("+farm2"):IsComplete() or itemcount(4339)<120
'Proceeding to farm |next |only if default
step
label	"farm2"
